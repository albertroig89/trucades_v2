            ...
            <nav class="navbar navbar-expand-lg  blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
                <div class="container-fluid">
                    <a  title="Diseñado por Albert Roig" data-placement="bottom" href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/AR_fblanc.png') }}" alt="Logo" style="width: 50px; height: auto;">
                    </a>
...
{{--                            </li>--}}
                            ...
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuUser" data-bs-toggle="dropdown" aria-expanded="false">
                                    @if(Auth::user()->avatar)
                                    <img src="{{ Auth::user()->avatar }}" alt="down-arrow" class="avatar avatar-sm me-3">
                                    @else
                                    <img src="{{ asset('images/AR_fblanc.png') }}" alt="down-arrow" class="avatar avatar-sm me-3">
                                    @endif
                                </a>
